...
let AudienceRegistration2Component = class AudienceRegistration2Component {
  ...
  submit(isValid, formValue) {
    ...
    this.apiService.doAudienceProfileUpdate(formObj).subscribe(res => {
      ...
      res.result == "failure" && this.utilService.presentToast(res.message);
      res.result == "success" && this.utilService.presentToast("Successfull registered") && this.router.navigate([""]);
    });
    console.log("form obj", isValid, formObj);
  }
...
let LoginComponent = class LoginComponent {
    ...
    ngOnInit() {
        ...
        this.loginForm = this.fb.group({
            ...
            mobileNo: ["", [_angular_forms__WEBPACK_IMPORTED_MODULE_5__.Validators.maxLength(10), _angular_forms__WEBPACK_IMPORTED_MODULE_5__.Validators.minLength(10)]],
            userName: [""]
        });
    }
    subscription() {
